...
/*	
	int matrix_a[4][4];
		...
		//int vektor_a[i] = {0};
		int matrix_b[4][4];
		createMatrix(4, 4, matrix_a);
		createMatrix(4, 4, matrix_b);

	printMatrix(4, 4, matrix_a);
	puts("");
	printMatrix(4, 4, matrix_b);
puts("");
		multiplyMatrix(4,4,4,4,matrix_a, matrix_b);
*/
	...
	for (int i = 2; i < 201; i++) {	
		...
		createMatrix(i, i, matrix_b);
		multiplyMatrix(i,i,i,i,matrix_a, matrix_b);
	}
